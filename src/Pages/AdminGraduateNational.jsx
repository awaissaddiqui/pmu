...
const AdminGraduateNational = () => {
    ...
    useEffect(() => {
        const fetchData = () => {
            try {
                const storedData = JSON.parse(localStorage.getItem("formDataGraduate")) || [];
            ...
            {formData.length > 0 ? (
                <>
                    ...
                    <div className="p-6 bg-white rounded-lg shadow-md">
                        ...
                        <img src={formData[0]?.attested_photo} alt="attested_photo" className="w-full h-full" />
                    </div>
...
export default AdminGraduateNational;