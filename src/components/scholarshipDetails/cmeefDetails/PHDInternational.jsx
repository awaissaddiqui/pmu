...
const PHDInternational = () => {
    ...
    const handleFileUpload = async (e, name) => {
        ...
        try {
            // Generate a unique file path by appending a timestamp
            ...
            >
                ...
                <label htmlFor="attested_photo">Upload Attested Photo
                    <input
                        ...
                        type="file" id="attested_photo"
                        onChange={(e) => handleFileUpload(e, "attested_photo")}
                        disabled={isUploading}
                        name="attested_photo" required />
                </label >
                {/* code for the table */}
                ...
                <div className="mt-6">
                    ...
                    <div className="flex flex-col  gap-4">
                        ...
                        <div>
                            <label className="block font-medium">Upload Undertaking</label>
                            <input type="file"
                                onChange={(e) => handleFileUpload(e, "undertaking_file")}
                                disabled={isUploading}
                                name='undertaking_file'
                                className="p-4 border rounded" required />
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div>
                            <label className="block font-medium">Upload NOC</label>
                            <input type="file"
