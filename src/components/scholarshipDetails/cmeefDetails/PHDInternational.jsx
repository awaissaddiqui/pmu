...
import { usePHDInternationalForm } from "../../../Context/PHDInternationalFormProvider";
...
const PHDInternational = () => {
    const { formData, dispatch, submitForm } = usePHDInternationalForm();
    ...
    const handleCheckboxChange = (event) => {
        ...
        dispatch({
            ...
            value: checked
                ...
                : (formData[name] || []).filter((item) => item !== value),  // ❌ Remove if unchecked
        });
    };

    const handleDownloadPhdData = () => {
        const filename = `PhD_International_Form_${formData.full_name}.pdf`;

        const otherData = [
            {
                title: "Revelant Categories",
                keys: [
                    "Nano-Technology",
                    "Forensic Science",
                    "Laser & Opto-Electronics",
                    "Anatomy",
                    "Physiology",
        ...
        const sections = [
            {
                ...
                keys: [
                    ...
                    'mobile_2', 'home',
                    'fax', 'office',
                    'references', 'other_nationality',
                    'marital_status', "spouse_details",
                    'scholarships_list',
                    'academic_honors',
                    'offer_detail',
                    'university_name',
            ...
            },
            {
                ...
                keys: [
                    ...
                    'fatherEmployed', 'fatherDesignation',
                    'fatherJoiningDate', 'spouseName',
                    'spouseAge', 'spousePhone',
                    'spouseMobile', 'spouseEmail',
                    'spouseEmployed',
                ]
            },
            {
                title: "Spouse Details",
                keys: ['spouseOrganization', "spouse_explanation"]
            },
            {
                title: "Total Income",
                keys: [
                    ...
                    'plotSize',
                    'address',
                    'otherAssets', "automobiles"
                ]
            },
            {
                title: "Income Details",
                keys: [
                    "disposable_income", "outstanding_loans"
                ]
            },
            {
        ...
        const tables = [
            {
                ...
                headers: ["Certificate/Degree", "Major Subjects", "Result Declaration Date", "Marks Obtained", "Total Marks", "CGPA", "Institution", "Board/University"],
            ...
            },
            {
                ...
                headers: ["", "Name of Employer with Address ", "Category of Employer(Federal/Prov Govt, SemiGovt, Autonomous,Corporation, Private)", "Designation with Grade BPS, Group etc. if applicab", "Nature of Job(Regular/Contractetc.)", "Job details(Teaching, R&D, Service, Technical, other etc)"],
                firstColumn: ["#"],
            },
            {
                title: "Total Income",
            ...
            },
            {
                ...
                firstColumn: ["Agriculture Income", "Income from Savings (Interests/Dividends)", "Pension", "Real State Holdings", "Support from relatives", "Others(please specify)", "Total Annual household income"],
            },
            {
            ...
            },
            {
                ...
                firstColumn: ['Educational Expenses', 'Food', 'Medical Expenses', 'Rent or Mortgage(if applicable)', 'Fuel And Vehicle Maintenance', 'Loan Payments', 'Clothing', 'Electricity Bill', 'Mobile phone bill', 'Entertainment', 'Servants Salaries', 'Taxes', 'Telephone Bill', 'Vactions', 'Others', 'Total annual expenses']
            },
            {
                title: 'Automobiles Details',
                tableTitle: 'automobiles_details',
                headers: ['Vehicle', 'Make', 'Manufactured Year', 'Engine CC', 'Value in RS'],
            ...
            },
            {
                ...
                firstColumn: ["Bank (specify name)", "Relative (specify relationship)", "Credit Card", "Employer", "Other (please specify)"]
            },
            {
                title: "Fee/Living Expenses on the Degree Programme",
                tableTitle: "degree_expenses",
                headers: ["Requirement", "Per Semester(RS)", "Per Year (RS)", "Total expenses for the degree course(Approximately)(RS)", "Duration of Study"],
                firstColumn: ["Tution Fees", "Boarding", "Lodging", "Transport", "Books", "Misc", "Total (a)"]
            },
            {
                title: "Applied for Financial Aid List",
                tableTitle: "financial_aid_agencies",
                headers: ["", "Agency/Foundations/Government", "Application Date", "Award Notification Date", "Expected Amount (Rs.)"],
                firstColumn: ["#"]
            },
        ...
        /*
          ...
          const smartHeaders = {
              education_details: ["Certificate/Degree", "Major Subjects", "Result Declaration Date", "Marks Obtained", "Total Marks", "CGPA", "Institution", "Board/University"],
              detail_of_courses_ms_level: ["", "Course Name", "Date/Semester", "Course Type (Core/Elective)", "Total Credits"],
              employment_details: ["", "Name of Employer with Address ", "Category of Employer(Federal/Prov Govt, SemiGovt, Autonomous,Corporation, Private)", "Designation with Grade BPS, Group etc.", "Nature of Job", "Job Details"],
              total_income: ["Particulars", "Monthly Salary", "From other sources if any", "Total"],
              annual_income: ["Particulars", "Rupees"],
              individual_assets: ["Particulars", "Business", "Savings and Investments", "Land and Building", "Agricultural Land", "Area/location of Agricultural Land"],
              average_family_expenses: ["Total Average Family Expenses (Annual)", "Rupees"],
              automobiles_details: ["Vehicle", "Make", "Manufactured Year", "Engine CC", "Value in RS"],
              land_ownership: ["Name of", "Locality", "Area (Kanals/Marlas/Sq. Feet)"],
              outstanding_loans_details: ["Particulars", "Amount", "Repayment due on (mm/yy)"],
              degree_expenses: ["Requirement", "Per Semester(RS)", "Per Year (RS)", "Total Expenses for Degree", "Duration of Study"],
              financial_aid_agencies: ["", "Agency/Foundations/Government", "Application Date", "Award Notification Date", "Expected Amount (Rs.)"]
          };
  
          const smartFirstColumn = {
              education_details: ['SSC/Matric', 'HSSC/Intermediate', 'Bachelors', 'Masters', 'MPhil', 'GRE/GAT', 'Medals', 'Other'],
              total_income: ['Father', 'Mother', 'Guardian', 'Self', 'Spouse', 'Others'],
              annual_income: ['Agriculture Income', 'Savings/Interest', 'Pension', 'Real Estate', 'Support Relatives', 'Others', 'Total'],
              individual_assets: ['Plots', 'Houses', 'Buildings', 'Land', 'Other (Specify)'],
              average_family_expenses: ['Education', 'Food', 'Medical', 'Rent', 'Fuel', 'Loan Payments', 'Clothing', 'Electricity', 'Mobile', 'Entertainment', 'Servants Salaries', 'Taxes', 'Telephone', 'Vacations', 'Others', 'Total'],
              automobiles_details: ['Vehicle 1', 'Vehicle 2', 'Vehicle 3'],
              land_ownership: ['Plots', 'Houses', 'Buildings', 'Land', 'Others'],
              outstanding_loans_details: ['Bank', 'Relative', 'Credit Card', 'Employer', 'Others'],
              degree_expenses: ['Tuition', 'Boarding', 'Lodging', 'Transport', 'Books', 'Misc', 'Total'],
              financial_aid_agencies: ["#"]
          };
          ...
          Object.keys(formData).forEach((key) => {
              if (Array.isArray(formData[key])) {
                  tables.push({
                      ...
                      tableTitle: key,
                      headers: smartHeaders[key] || [],
                      firstColumn: smartFirstColumn[key] || []
                  });
              } else {
                  let lastSection = sections[sections.length - 1];
                  if (!lastSection || lastSection.keys.length >= 15) {
                      sections.push({
                          title: `Section ${sections.length + 1}`,
                          keys: [key]
                      });
                  } else {
                      lastSection.keys.push(key);
                  }
              }
          });
          */
        ...
        downloadPdfData(formData, filename, sections, tables, otherData);
...

            {
                showModal ? (
                    <DownloadFormData
                        ...
                        show={showModal}
                        handleDownload={handleDownloadPhdData}
                    />
                ) : (
                    <>
                        ...
                        <form className="w-full max-w-full bg-white shadow-lg rounded-lg p-6 space-y-4"
                            onSubmit={(e) => {
                                e.preventDefault();
                                submitForm();
                        ...
                        >
                            <h2 className="text-2xl font-bold mb-4">Chief Minister Education Endowment Fund (CMEEF) Scholarships Application Form for Graduate International Program (PhD/Dphil)</h2>
                            ...
                            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-6">
                                {[
                                    ...
                                    { label: "Father CNIC No", name: "father_cnic_no", type: "text" },
                                    ...
                                    { label: "Permanent Address (if different)", name: "permanent_address", type: "text" },
                            ...
                            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-6">
                                ...
                                {[
                                    { label: "List of scholarships or fellowships held at present or in past", name: "scholarships_list", type: "text" },
                                    { label: "Indicate any academic honors/medals or prizes received", name: "academic_honors", type: "text" },
                                    { label: "Offer detail for MS/PhD/DPhil Program", name: "offer_detail", type: "text" },
                                    { label: "Name of University", name: "university_name", type: "text" },
                                    { label: "Country", name: "country", type: "text" },
                                    { label: "Date of Commencement of classes", name: "commencement_date", type: "date" },
                                    { label: "Date of Completion", name: "completion_date", type: "date" },
                                    { label: "University Ref/ID Code", name: "university_code", type: "text" },
                                    { label: "Major area", name: "major_area", type: "text" },
                                    { label: "Specialization", name: "specialization", type: "text" },
                                    { label: "Title of MS/PhD/DPhil", name: "title", type: "text" },
                                    { label: "Supervisor Name", name: "supervisor_name", type: "text" },
                                    { label: "Supervisor Email", name: "supervisor_email", type: "email" },
                                    { label: "Supervisor Contact", name: "supervisor_contact", type: "tel" },
                                    { label: "Research Publication (Use extra sheet where required)", name: "research_publication", type: "text" },
                            ...
                            <h2 className="text-2xl mt-8">Check the revelant Categories</h2>
                            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-6">
                                {[
                                    { label: "Nano-Technology", name: "subject", type: "checkbox" },
                                    { label: "Forensic Science", name: "subject", type: "checkbox" },
                                    { label: "Laser & Opto-Electronics", name: "subject", type: "checkbox" },
                                    { label: "Anatomy", name: "subject", type: "checkbox" },
                                    { label: "Physiology", name: "subject", type: "checkbox" },
                                    { label: "Computer Communication & Network", name: "subject", type: "checkbox" },
                                    { label: "Economics", name: "subject", type: "checkbox" },
                                    { label: "Water Resource Management", name: "subject", type: "checkbox" },
                                    { label: "Petroleum Engineering", name: "subject", type: "checkbox" },
                                    { label: "English Literature", name: "subject", type: "checkbox" },
                                    { label: "Modeling & Simulation", name: "subject", type: "checkbox" },
                                    { label: "Mining/Mineral Engineering", name: "subject", type: "checkbox" },
                                ]
                                    .map((field) => (
                                        <label key={field.label} className="flex items-center space-x-2">
                                            <input
                                                type="checkbox"
                                                name={field.name}
                                                value={field.label}
                                                checked={formData[field.name]?.includes(field.label) || false} // ✅ Bind checked state
                                                onChange={handleCheckboxChange} // ✅ Handle multiple selections
                                                className="mr-2"
                                            />
                                            {field.label}
                                        </label>
                            ...
                            <h4 className='font-sm'>Please specify monthly income information for each member of your family, including yourself and your spouse
                                (if applicable). Use a separate sheet if needed. Specify monetary values in Rupees  </h4>
                            <div className="mt-6 overflow-x-auto">
                                <DynamicTable
                                    tableTitle={"total_income"}
                                    headers={["Particulars", "Monthly Salary", "From other sources if any", "Total"]}
                            ...
                            {/* Annual Income */}
                            <div className="mt-6 overflow-x-auto">
                                <h2 className='text-xl font-semibold'>Please specify Annual income information from the sources mentioned below:</h2>
                                <DynamicTable
                                    tableTitle={"annual_income"}
                                    headers={["Particulars", "Rupees"]}
                                    dispatch={dispatch}
                            ...
                            {/* Land Ownership Table */}
                            {
                                formData.otherAssets === "yes" && (
                                    ...
                                    <div className="mt-6 overflow-x-auto">
                                        <h2 className="text-lg font-bold mb-4">If you answered YES, please provide the following details:</h2>
                                        <DynamicTable
                                            tableTitle={"land_ownership"}
                                            headers={["Name of", "Locality", "Area (Kanals/Marlas/Sq. Feet)"]}
                                            dispatch={dispatch}
                            ...
                            <div className="mt-6 overflow-x-auto">
                                <h2 className='md:text-xl text-md font-semibold'>Please specify individual assets for each member of your family, including yourself and your spouse (if applicable).
                                    Use a separate sheet if needed. Specify monetary values in Rupees.</h2>
                                <DynamicTable
                                    tableTitle={"individual_assets"}
                                    headers={["Particulars", "Business", "Savings and Investments", "Land and Building", "Agricultural Land", "Area/location of  Agricultural Land"]}
                                    dispatch={dispatch}
                            ...
                            <fieldset className="border p-4 rounded-lg mb-6">
                                <p className="font-medium mb-2">Does your family own any automobile(s)?</p>
                                <select
                                    name="automobiles"
                                    required
                                    className="w-full p-2 border rounded-md"
                            ...
                            <div className="mt-6 overflow-x-auto">
                                <h2 className='md:text-xl text-md font-semibold'>Please specify Annual income information from the sources mentioned below:</h2>
                                <DynamicTable
                                    tableTitle={"average_family_expenses"}
                                    headers={["Total Average Family Expenses (Annual)", "Rupees"]}
                                    dispatch={dispatch}
                            ...
                            <label className="block font-medium">If the monthly/annual disposable income is negative, kindly explain the reasons for the gap and any arrangements through which the differential is being met by the family.
                                <input type="text"
                            ...
                            {formData.outstanding_loans === "yes" && (
                                ...
                                <div className="mt-6 overflow-x-auto">
                                    <h2 className='text-xl font-semibold'>If yes, please indicate loans taken from:</h2>
                                    <DynamicTable
                                        tableTitle={"outstanding_loans_details"}
                                        headers={["Particulars", "Amount", "Repayment due on (mm/yy)"]}
                                        dispatch={dispatch}
                            ...
                            <p>Requirement of funds for degree: (Please mention all the amounts in Pak Rupes) </p>
                            <div className="mt-6 overflow-x-auto">
                                <DynamicTable
                                    tableTitle={"degree_expenses"}
                                    headers={["Requirement", "Per Semester(RS)", "Per Year (RS)", "Total expenses for the degree course(Approximately)(RS)", "Duration of Study"]}
                            ...
                            {[
                                { label: "How will the proposed degree be of benefit to Pakistan/Khyber Pakhtunkhwa?", name: "benefit_to_pakistan", type: "textarea" },
                                { label: "What skills and knowledge do you hope to gain from your studies? How do you propose to use them (if possible, list specific actions) in Pakistan/Khyber Pakhtunkhwa?", name: "skills_and_knowledge", type: "textarea" },
                                { label: "Is there anything else you would like to add in support of your application for this scholarship?", name: "supporting_statement", type: "textarea" },
                                { label: "How do you relate the proposed studies to your previous study/achievements and your present job/occupation?", name: "proposed_studies", type: "textarea" },
                                { label: "Where would you like to join in Pakistan after completion of your MS/MPhil/PhD studies? [only for those applicants who are not already employed in Pakistan]", name: "join_after_completion", type: "textarea" }
                            ].map((field) => (
                                <FormInput
                                    key={field.name}
                                    {...field}
                            ...
                            <div className='flex justify-end'>
                                ...
                                <button
                                    type="submit"
                                    className={`bg-primary hover:bg-secondary text-white font-bold w-full md:w-48 py-3.5 px-12 rounded ${!isFileUploaded ? "opacity-50 cursor-not-allowed" : "cursor-pointer"
                                        }`}
...
export default PHDInternational;
