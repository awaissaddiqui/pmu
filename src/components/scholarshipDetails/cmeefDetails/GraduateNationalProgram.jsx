            ...
            >
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-6">
                    ...
                    {[
                        ...
                        { label: "Closing date of admission of the institution", name: "closing_date", type: "date" },
                ...
                <div className="mt-6 overflow-x-auto">
                    ...
                    <DynamicTable
                        ...
                        headers={["", "Title of research project", "Area of Research", "Published in International/Local Journal", "Date of Publication", "Impact Factor of Journal"]}
                        dispatch={dispatch}
                        firstColumnTitle={"#"}
                        numRows={5}
                    />
